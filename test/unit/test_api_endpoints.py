...
def main():
    ...
    print("\n💡 Key Features:")
    print("   ✓ Wallet management (create, import, sign)")
    print("   ✓ Balance queries (PHN, tokens, assets)")
    print("   ✓ Transaction management (send, query, history)")
    print("   ✓ Blockchain explorer (blocks, search, stats)")
    print("   ✓ Asset tokenization (create, transfer, fractionalize)")
    print("   ✓ Custom token platform (create, mint, burn, transfer)")
...
if __name__ == "__main__":
    print("\n⚠️  Make sure PHN node is running:")
