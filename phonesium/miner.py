...
from phonesium.exceptions import NetworkError
...
class Miner:
    ...
    def __init__(self, wallet: Wallet, node_url: str = "http://localhost:8000"):
        """
        Initialize miner
    ...
    def mine_block(self, timeout: int = 60) -> Optional[Dict]:
        ...
        while True:
            ...
            if elapsed > timeout:
                ...
                print(f"[MINER] Tried {hashes_tried:,} hashes ({hashes_tried/elapsed:.0f} H/s)")
                return None
